...
namespace Prime31.TransitionKit
{
	public class TransitionKit : MonoBehaviour
	{
		...
		{
            var halfHeight = (Camera.main.orthographicSize < 5) ? 5f : 5.01f; // 5 is the camera.orthoSize which is the half height
		...
		IEnumerator setupCameraAndTexture()
		{
            ...
            transitionKitCamera.orthographicSize = (Camera.main.orthographicSize < 5) ? 5f : 5.01f;
